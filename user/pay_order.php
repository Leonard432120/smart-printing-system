  ...
  <script>
    function makePayment(){
      PaychanguCheckout({
        ...
        amount: <?= $amount ?>,
        currency: "MWK",
        callback_url: "https://0735b72b1a10.ngrok-free.app/smart-printing-system/user/verify_payment.php",
        return_url: "https://0735b72b1a10.ngrok-free.app/smart-printing-system/user/payment_success.php",
        customer: {
          email: "<?= $email ?>",
